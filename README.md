...
| Wazuh API         | https://localhost:55000      | wazuh-wui   | *(from .env)*         |
| CTFd              | http://localhost:8000        | *(setup required)* | *(setup required)* |
| Nginx (Dashboard) | http://localhost:8880        | *(proxied)* | *(proxied)*           |
